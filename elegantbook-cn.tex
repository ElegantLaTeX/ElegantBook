...
\begin{figure}[h!]
  \centering
  \begin{tikzpicture}[scale=0.8, every node/.style={minimum width=1.5cm, minimum height=1cm, draw, anchor=center}]
      % 绘制一维数组的单元格
      \node (a00) at (0, 0) {$a_{0,0}$};
      \node (a01) at (1.5, 0) {$a_{0,1}$};
      \node (dots1) at (3, 0) {$\dots$};
      \node (a0n) at (4.5, 0) {$a_{0,n-1}$};
      \node (a10) at (6, 0) {$a_{1,0}$};
      \node (a11) at (7.5, 0) {$a_{1,1}$};
      \node (dots2) at (9, 0) {$\dots$};
      \node (a1n) at (10.5, 0) {$a_{1,n-1}$};
      \node (dots3) at (12, 0) {$\dots$};
      \node (amn) at (13.5, 0) {$a_{m-1,n-1}$};
  \end{tikzpicture}
...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}[scale=0.8, every node/.style={minimum width=1.5cm, minimum height=1cm, draw, anchor=center}]
      % 绘制一维数组的单元格
      \node (a00) at (0, 0) {$a_{0,0}$};
      \node (a10) at (1.5, 0) {$a_{1,0}$};
      \node (dots1) at (3, 0) {$\dots$};
      \node (am0) at (4.5, 0) {$a_{m-1,0}$};
      \node (a01) at (6, 0) {$a_{0,1}$};
      \node (a11) at (7.5, 0) {$a_{1,1}$};
      \node (dots2) at (9, 0) {$\dots$};
      \node (am1) at (10.5, 0) {$a_{m-1,1}$};
      \node (dots3) at (12, 0) {$\dots$};
      \node (amn) at (13.5, 0) {$a_{m-1,n-1}$};
  \end{tikzpicture}
