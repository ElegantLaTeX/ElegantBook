...
This template contains 5 color themes,they are  \colorsetDemo{green}\footnote{original default theme.}, \colorsetDemo{cyan}{\lstinline{cyan}}, \colorsetDemo{blue} (default), \colorsetDemo{gray}, \colorsetDemo{black}. You can choose \lstinline{green} with  
\begin{lstlisting}
