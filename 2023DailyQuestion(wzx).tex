\documentclass[lang=cn,10pt,bibtex,gray]{elegantbook}
...
$$
\begin{aligned}
&\quad\  \sum_{k=0}^{2^n-1} \left(\sin^2\frac{k\pi + x}{2^n}\right)^{-1}\\
&=\sum_{k=0}^{2^{n-1}-1} \left(\sin^2\frac{k\pi + x}{2^n}\right)^{-1}+
\sum_{k=2^{n-1}}^{2^{n}-1} \left(\sin^2\frac{k\pi + x}{2^n}\right)^{-1}\\
&=\sum_{k=0}^{2^{n-1}-1} \left(\sin^2\frac{k\pi + x}{2^n}\right)^{-1}+
\sum_{k=-2^{n-1}}^{-1} \left(\sin^2\frac{(k+2^n)\pi + x}{2^n}\right)^{-1} 
&& \left(\text{右式} k \to k-2^n\right)\\
&=\sum_{k=0}^{2^{n-1}-1} \left(\sin^2\frac{k\pi + x}{2^n}\right)^{-1}+
\sum_{k=-2^{n-1}}^{-1} \left(\sin^2\frac{k\pi + x}{2^n}\right)^{-1}
&& \left(\sin^2\frac{k\pi + x}{2^n}=\sin^2\frac{(k+2^n)\pi + x}{2^n}\right)\\
&=\sum_{k=-2^{n-1}}^{2^{n-1}-1} \left(\sin^2\frac{k\pi + x}{2^n}\right)^{-1}
\end{aligned}$$
